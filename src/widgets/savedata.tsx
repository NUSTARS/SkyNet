        ...
        const csvData = [headers.join(',')].concat(
            sensorData.ToF.map((value, index) => {
                return [
                    ...
                    sensorData.accelX[index],
                    sensorData.accelY[index],
                    sensorData.accelZ[index],
                    sensorData.gyroX[index],
                    sensorData.gyroY[index],
                    sensorData.gyroZ[index],
                    sensorData.magX[index],
                    sensorData.magY[index],
                    sensorData.magZ[index],
                ].join(',');
            })
        ).join('\n');
